                            ...
                            <div class="col-12">
                                ...
                                <div class="card-box">
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                            <label for="range_07" class="col-sm-2 control-label">Prettify Numbers<span class="display-block font-13 text-muted f-s-12 clearfix">Prettify enabled. Much better!</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" id="range_07">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="range_08" class="col-sm-2 control-label">Disabled<span class="display-block font-13 text-muted f-s-12 clearfix">Lock slider by using disable option</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" id="range_08">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="range_09" class="col-sm-2 control-label">Extra Example<span class="display-block font-13 text-muted f-s-12 clearfix">Whant to show that max number is not the biggest one?</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" id="range_09">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="range_10" class="col-sm-2 control-label">Use decorate_both option<span class="display-block font-13 text-muted f-s-12 clearfix">Use decorate_both option</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" id="range_10">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="range_11" class="col-sm-2 control-label">Postfixes<span class="display-block font-13 text-muted f-s-12 clearfix">Using postfixes</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" id="range_11">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="range_12" class="col-sm-2 control-label">Hide<span class="display-block font-13 text-muted f-s-12 clearfix">Or hide any part you wish</span></label>
                                            <div class="col-sm-10">

                ...
                <nav class="navbar-custom">
                    ...
                    <ul class="list-inline float-right mb-0">
                        <li class="list-inline-item dropdown notification-list">
                            <a class="nav-link dropdown-toggle arrow-none waves-light waves-effect" data-toggle="dropdown" href="{{asset('#" role="button"
                        ...
                        <li class="list-inline-item dropdown notification-list">
                            <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="{{asset('#" role="button"
                               aria-haspopup="false" aria-expanded="false">
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li class="hidden-mobile app-search">
                            <form role="search" class="">
                                ...
                                <a href="{{asset('('')}}"><i class="fa fa-search"></i></a>
                            </form>
                        </li>
                    </ul>
                            ...
                            <div class="col-xl-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Calendar</h4>
                                        ...
                                        <li class="breadcrumb-item"><a href="{{route('#">Uplon</a></li>
                                ...
                                <div class="card-box">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <a href="{{asset('#" data-toggle="modal" data-target="#add-category" class="btn btn-lg btn-success btn-block waves-effect m-t-20 waves-light">
            ...
            <div class="side-bar right-bar">
                <div class="nicescroll">
                    <ul class="nav nav-pills nav-justified">
                        <li class="nav-item">
                            <a href="{{asset('#home-2"  class="nav-link active" data-toggle="tab" aria-expanded="false">
                                Activity
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{asset('#messages-2" class="nav-link" data-toggle="tab" aria-expanded="true">
                                Settings
                            </a>
                        </li>
                    </ul>
                            ...
                            <div class="timeline-2">
                                <div class="time-item">
                                    <div class="item-info">
                                        ...
                                        <p><strong><a href="{{asset('#" class="text-info">John Doe</a></strong> Uploaded a photo <strong>"DSC000586.jpg')}}"</strong></p>
                                    </div>
                                </div>
                                ...
                                <div class="time-item">
                                    <div class="item-info">
                                        ...
                                        <p><a href="{{asset('" class="text-info">Lorem</a> commented your post.</p>
                                ...
                                <div class="time-item">
                                    <div class="item-info">
                                        ...
                                        <p><a href="{{asset('" class="text-info">Jessi</a> attended a meeting with<a href="{{asset('#" class="text-success">John Doe</a>.</p>
                                        <p><em>"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam laoreet tellus ut tincidunt euismod. "</em></p>
                                    </div>
                                </div>
                                ...
                                <div class="time-item">
                                    <div class="item-info">
                                        ...
                                        <p><strong><a href="{{asset('#" class="text-info">John Doe</a></strong>Uploaded 2 new photos</p>
                                    </div>
                                </div>

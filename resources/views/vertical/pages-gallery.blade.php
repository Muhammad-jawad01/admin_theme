                        ...
                        <div class="port text-center m-b-20">
                            <div class="portfolioContainer">
                                <div class="gallery-box natural personal">
                                    <div class="thumb">
                                        <a href="{{asset('assets/images/gallery/12.jpg')}}" class="image-popup" title="Screenshot-1">
                                            <img src="{{asset('assets/images/gallery/12.jpg')}}" class="thumb-img" alt="work-thumbnail">
                                        </a>
                                ...
                                <div class="gallery-box creative personal photography">
                                    <div class="thumb">
                                        <a href="{{asset('assets/images/gallery/2.jpg')}}" class="image-popup" title="Screenshot-2">
                                ...
                                <div class="gallery-box natural creative">
                                    <div class=" thumb">
                                        <a href="{{asset('assets/images/gallery/3.jpg')}}" class="image-popup" title="Screenshot-3">
                                ...
                                <div class="gallery-box personal photography">
                                    <div class="thumb">
                                        <a href="{{asset('assets/images/gallery/4.jpg')}}" class="image-popup" title="Screenshot-4">
                                ...
                                <div class="gallery-box creative photography">
                                    <div class="thumb">
                                        <a href="{{asset('assets/images/gallery/9.jpg')}}" class="image-popup" title="Screenshot-5">
                                            <img src="{{asset('assets/images/gallery/9.jpg')}}" class="thumb-img" alt="work-thumbnail">
                                        </a>
                                        <div class="gal-detail">
                                            <h4 class="m-t-10">Nature Image</h4>
                                            <p class="text-muted">
                                ...
                                <div class="gallery-box natural photography">
                                    <div class="thumb">
                                        <a href="{{asset('assets/images/gallery/6.jpg')}}" class="image-popup" title="Screenshot-6">
                                ...
                                <div class="gallery-box personal photography creative">
                                    <div class="thumb">
                                        <a href="{{asset('assets/images/gallery/7.jpg')}}" class="image-popup" title="Screenshot-7">
                                            <img src="{{asset('assets/images/gallery/7.jpg')}}" class="thumb-img" alt="work-thumbnail">
                                        </a>
                                        <div class="gal-detail">
                                            <h4 class="m-t-10">Nature Image</h4>
                                            <p class="text-muted">
                                ...
                                <div class="gallery-box creative photography natural">
                                    <div class="thumb">
                                        <a href="{{asset('assets/images/gallery/8.jpg')}}" class="image-popup" title="Screenshot-8">
                                            <img src="{{asset('assets/images/gallery/8.jpg')}}" class="thumb-img" alt="work-thumbnail">
                                        </a>
                                        <div class="gal-detail">
                                            <h4 class="m-t-10">Nature Image</h4>
                                            <p class="text-muted">
                                ...
                                <div class="gallery-box natural personal">
                                    <div class="thumb">
                                        <a href="{{asset('assets/images/gallery/5.jpg')}}" class="image-popup" title="Screenshot-9">
                                ...
                                <div class="gallery-box photography creative">
                                    <div class="thumb">
                                        <a href="{{asset('assets/images/gallery/10.jpg')}}" class="image-popup" title="Screenshot-10">
                                            <img src="{{asset('assets/images/gallery/10.jpg')}}" class="thumb-img" alt="work-thumbnail">
                                        </a>
                                        <div class="gal-detail">
                                            <h4 class="m-t-10">Nature Image</h4>
                                            <p class="text-muted">
                                ...
                                <div class="gallery-box creative photography">
                                    <div class="thumb">
                                        <a href="{{asset('assets/images/gallery/11.jpg')}}" class="image-popup" title="Screenshot-11">
                                            <img src="{{asset('assets/images/gallery/11.jpg')}}" class="thumb-img" alt="work-thumbnail">
                                        </a>
                                        <div class="gal-detail">
                                            <h4 class="m-t-10">Nature Image</h4>
                                            <p class="text-muted">
                                ...
                                <div class="gallery-box natural creative personal">
                                    <div class="thumb">
                                        <a href="{{asset('assets/images/gallery/1.jpg')}}" class="image-popup" title="Screenshot-12">

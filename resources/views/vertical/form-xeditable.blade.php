...
<html lang="en">
    ...
    <head>
        ...
        <!-- App Favicon -->
        <link rel="shortcut icon" href="{{asset(assests/images/favicon.ico')}}">
    ...
    <body class="fixed-left">
                    ...
                    <ul class="list-inline float-right mb-0">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-arrow-success dropdown-lg" aria-labelledby="Preview">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-faded">
                                        <img src="{{asset(assests/images/users/avatar-2.jpg')}}" alt="img" class="rounded-circle img-fluid">
                                    </div>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-faded">
                                        <img src="{{asset(assests/images/users/avatar-3.jpg')}}" alt="img" class="rounded-circle img-fluid">
                                    </div>
                                    <p class="notify-details">
                                        <b>Carlos Crouch</b>
                                        <span>New tasks needs to be done</span>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-faded">
                                        <img src="{{asset(assests/images/users/avatar-4.jpg')}}" alt="img" class="rounded-circle img-fluid">
                                    </div>
                                    <p class="notify-details">
                                        <b>Robert Taylor</b>
                                        <span>New tasks needs to be done</span>
                        ...
                        <li class="list-inline-item dropdown notification-list">
                            <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                               aria-haspopup="false" aria-expanded="false">
                                <img src="{{asset(assests/images/users/avatar-1.jpg')}}" alt="user" class="rounded-circle">
                            </a>
        ...
        <script src="{{asset(assests/pages/jquery.xeditable.js')}}"></script>

        <!-- App js -->
        <script src="{{asset(assests/js/jquery.core.js')}}"></script>
        <script src="{{asset(assests/js/jquery.app.js')}}"></script>

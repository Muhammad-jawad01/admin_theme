                        ...
                        <div class="row">
                            <div class="col-md-6  col-xl-3">
                                <div class="card-box widget-user">
                                    <div>
                                        <img src="{{asset('assets/images/users/avatar-3.jpg" class="img-responsive rounded-circle" alt="user">
                            ...
                            <div class="col-md-6  col-xl-3">
                                <div class="card-box widget-user">
                                    <div>
                                        <img src="{{asset('assets/images/users/avatar-2.jpg" class="img-responsive rounded-circle" alt="user">
                                        <div class="wid-u-info">
                            ...
                            <div class="col-md-6  col-xl-3">
                                <div class="card-box widget-user">
                                    <div>
                                        <img src="{{asset('assets/images/users/avatar-1.jpg" class="img-responsive rounded-circle" alt="user">
                                        <div class="wid-u-info">
                            ...
                            <div class="col-md-6  col-xl-3">
                                <div class="card-box widget-user">
                                    <div>
                                        <img src="{{asset('assets/images/users/avatar-10.jpg" class="img-responsive rounded-circle" alt="user">
                                        <div class="wid-u-info">

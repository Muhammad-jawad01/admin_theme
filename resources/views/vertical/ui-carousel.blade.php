                                            ...
                                            <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                                                ...
                                                <div class="carousel-inner" role="listbox">
                                                    <div class="carousel-item active">
                                                        <img class="d-block img-fluid" src="{{asset('assets/images/big/1.jpg')}}" alt="First slide" />
                                                    ...
                                                    <div class="carousel-item">
                                                        <img class="d-block img-fluid" src="{{asset('assets/images/big/2.jpg')}}" alt="Second slide" />
                                                        <div class="carousel-caption d-none d-md-block">
                                                    ...
                                                    <div class="carousel-item">
                                                        <img class="d-block img-fluid" src="{{asset('assets/images/big/3.jpg')}}" alt="Third slide" />
                                                        <div class="carousel-caption d-none d-md-block">

                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-3">
                                ...
                                <div class="card m-b-20">
                                    <img class="card-img-top img-fluid" src="{{asset('assets/images/gallery/9.jpg')}}" alt="Card image cap">
                                    <div class="card-body">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                ...
                                <div class="card m-b-20">
                                    <img class="card-img-top img-fluid" src="{{asset('assets/images/gallery/3.jpg')}}" alt="Card image cap">
                                    <div class="card-body">
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up the bulk of the card's content.</p>
                                    </div>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                ...
                                <div class="card m-b-20">
                                    ...
                                    <img class="img-fluid" src="{{asset('assets/images/gallery/12.jpg')}}" alt="Card image cap">
                                    <div class="card-body">
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up the bulk of the card's content.</p>
                                        <a href="#" class="card-link">Card link</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="card m-b-20">
                                    ...
                                    <img class="card-img-bottom img-fluid" src="{{asset('assets/images/gallery/2.jpg')}}" alt="Card image cap">
                                </div>
                            </div>
            
                            <div class="col-lg-4">
                                <div class="card m-b-20 text-white">
                                    <img class="card-img img-fluid" src="{{asset('assets/images/gallery/3.jpg')}}" alt="Card image">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="card-group">
                                    ...
                                    <div class="card m-b-20">
                                        <img class="card-img-top img-fluid" src="{{asset('assets/images/gallery/11.jpg')}}" alt="Card image cap">
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
                                            <p class="card-text">This is a wider card with supporting text below as a
                            ...
                            <div class="col-12">
                                ...
                                <div class="card-deck-wrapper">
                                    <div class="card-deck">
                                        ...
                                        <div class="card m-b-20">
                                            <img class="card-img-top img-fluid" src="{{asset('assets/images/gallery/12.jpg')}}" alt="Card image cap">
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="card-columns">
                                    ...
                                    <div class="card m-b-20">
                                        <img class="card-img img-fluid" src="{{asset('assets/images/gallery/4.jpg')}}" alt="Card image cap">
                                    </div>
                                    <div class="card m-b-20 card-body text-right">
                                        <blockquote class="card-bodyquote mb-0">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere
